          ...
          <div className="p-5">
            ...
            <div className="mb-8">
                ...
                <div className="space-y-3">
                    <p><strong className="font-semibold text-black">Condition:</strong> Trigger when Sensor #{auto.sensor_id} &gt; {auto.sensor_value}</p>
                    <p><strong className="font-semibold text-black">Action Pump:</strong> {auto.pump_id ? `Turn On Pump #${auto.pump_id}` : "None"}</p>
                    <p><strong className="font-semibold text-black">Action Valve:</strong> {auto.valve_id ? `Open Valve #${auto.valve_id}` : "None"}</p>
                </div>
            </div>

            {/* Bagian History Log (BARU) */}
            <div>
